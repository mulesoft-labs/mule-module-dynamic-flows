...
/**
 * RunMessageProcessor invokes the {@link org.mule.module.dynamicFlows.DynamicFlowsModule#run(java.lang.String, java.lang.String, java.lang.Object)} method in {@link DynamicFlowsModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class RunMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private String _flowNameType;
    private Object request;
    private Object _requestType;
    private static Logger logger = LoggerFactory.getLogger(RunMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setFlowName(Object value) {
        this.flowName = value;
    }
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("run"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            castedModuleObject = ((DynamicFlowsModuleLifecycleAdapter) moduleObject);
        }
        try {
            String transformedContextName = ((String) evaluateAndTransform(muleMessage, RunMessageProcessor.class.getDeclaredField("_contextNameType").getGenericType(), contextName));
            String transformedFlowName = ((String) evaluateAndTransform(muleMessage, RunMessageProcessor.class.getDeclaredField("_flowNameType").getGenericType(), flowName));
            Object transformedRequest = ((Object) evaluateAndTransform(muleMessage, RunMessageProcessor.class.getDeclaredField("_requestType").getGenericType(), request));
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = castedModuleObject.run(transformedContextName, transformedFlowName, transformedRequest);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("run"), event, e);
        }
    }
